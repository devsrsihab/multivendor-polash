                                                        ...
                                                        <div class="modal-body">
                                                            @if($detail->digital_file_after_sell)
                                                                <div class="mb-4">
                                                                    ...
                                                                    <a href="{{ asset('storage/appproduct/digital-product/'.$detail->digital_file_after_sell) }}"
                            ...
                            <div class="media flex-wrap gap-3">
                                <div class="">
                                    <img class="avatar rounded-circle avatar-70"
                                         ...
                                         src="{{asset('storage/appprofile/'.$order->customer->image)}}"
                                         alt="Image">
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            @if($order->seller_is == 'admin')
                                <div class="mr-3">
                                    <img class="avatar rounded avatar-70" onerror="this.src='https://6valley.6amtech.comassets/front-end/img/image-place-holder.png'"
                                         src="{{asset("storage/appcompany/$company_web_logo")}}" alt="">
                                </div>
                            ...
                            @else
                                @if(!empty($order->seller->shop))
                                    <div class="mr-3">
                                        <img class="avatar rounded avatar-70" onerror="this.src='https://6valley.6amtech.comassets/front-end/img/image-place-holder.png'"
                                             src="{{asset('storage/appshop')}}/{{$order->seller->shop->image}}" alt="">
                                    </div>
                                    <div class="media-body d-flex flex-column gap-2">
    ...
    <script>
        ...
        function initializegLocationMap() {
            ...
            google.maps.event.addListener(marker, 'click', (function (marker) {
                return function () {
                    infowindow.setContent("<div class='float-left'><img class='__inline-5' src='{{asset('storage/appprofile/')}}{{$order->customer->image??""}}'></div><div class='float-right __p-10'><b>{{$order->customer->f_name??""}} {{$order->customer->l_name??""}}</b><br/>{{$shipping_address->address??""}}</div>");
